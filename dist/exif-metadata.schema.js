...
const ImageTags = zod_1.z.object({
    ...
    StripOffsets: zod_1.z.array(zod_1.z.number())
    ...
    PlanarConfiguration: zod_1.z.number()
    ...
    PageNumber: zod_1.z.number()
        .describe('The page number of the page from which this image was scanned.'),
    TransferFunction: zod_1.z.array(zod_1.z.number())
    ...
    PrimaryChromaticities: zod_1.z.array(zod_1.z.number())
    ...
    YCbCrPositioning: zod_1.z.number()
    ...
    ReferenceBlackWhite: zod_1.z.array(zod_1.z.number())
    ...
    XMLPacket: zod_1.z.number()
        .describe('XMP Metadata (Adobe technote 9-14-02).'),
    Rating: zod_1.z.number()
        .describe('Rating tag used by Windows.'),
    RatingPercent: zod_1.z.number()
        .describe('Rating tag used by Windows, value in percent.'),
    VignettingCorrParams: zod_1.z.number(),
    ChromaticAberrationCorrParams: zod_1.z.number(),
    DistortionCorrParams: zod_1.z.number(),
    ...
    CFARepeatPatternDim: zod_1.z.number()
    ...
    ISOSpeedRatings: zod_1.z.number()
    ...
    LocalizedCameraModel: zod_1.z.number()
    ...
    CFALayout: zod_1.z.number()
        .describe('Describes the spatial layout of the CFA.'),
    LinearizationTable: zod_1.z.number()
    ...
    BlackLevelDeltaH: zod_1.z.number()
    ...
    BlackLevelDeltaV: zod_1.z.number()
    ...
    DefaultCropOrigin: zod_1.z.number()
    ...
    DefaultCropSize: zod_1.z.number()
    ...
    CameraCalibration1: zod_1.z.number()
    ...
    CameraCalibration2: zod_1.z.number()
    ...
    ReductionMatrix1: zod_1.z.number()
    ...
    ReductionMatrix2: zod_1.z.number()
    ...
    BaselineExposure: zod_1.z.number()
    ...
    BaselineSharpness: zod_1.z.number()
    ...
    BayerGreenSplit: zod_1.z.number()
    ...
    LinearResponseLimit: zod_1.z.number()
    ...
    MakerNoteSafety: zod_1.z.number()
    ...
    CalibrationIlluminant1: zod_1.z.number()
    ...
    CalibrationIlluminant2: zod_1.z.number()
    ...
    BestQualityScale: zod_1.z.number()
    ...
    RawDataUniqueID: zod_1.z.number()
    ...
    OriginalRawFileName: zod_1.z.number()
    ...
    AsShotPreProfileMatrix: zod_1.z.number()
    ...
    CurrentPreProfileMatrix: zod_1.z.number()
    ...
    ColorimetricReference: zod_1.z.number()
    ...
    ProfileHueSatMapDims: zod_1.z.number()
    ...
    PreviewSettingsName: zod_1.z.number()
    ...
    PreviewDateTime: zod_1.z.string()
    ...
    SubTileBlockSize: zod_1.z.number()
    ...
    RowInterleaveFactor: zod_1.z.number()
    ...
    ProfileLookTableDims: zod_1.z.number()
    ...
    OriginalDefaultFinalSize: zod_1.z.number(),
    OriginalBestQualityFinalSize: zod_1.z.number(),
    OriginalDefaultCropSize: zod_1.z.number(),
    ProfileHueSatMapEncoding: zod_1.z.number(),
    ProfileLookTableEncoding: zod_1.z.number(),
    BaselineExposureOffset: zod_1.z.number(),
    DefaultBlackRender: zod_1.z.number(),
    NewRawImageDigest: zod_1.z.number(),
    //RawToPreviewGain: z.buffer(),
    DefaultUserCrop: zod_1.z.number(),
    DepthFormat: zod_1.z.number(),
    DepthNear: zod_1.z.number(),
    DepthFar: zod_1.z.number(),
    DepthUnits: zod_1.z.number(),
    DepthMeasureType: zod_1.z.number(),
    EnhanceParams: zod_1.z.string(),
    //ProfileGainTableMap: z.buffer(),
    SemanticName: zod_1.z.string(),
    SemanticInstanceID: zod_1.z.string(),
    CalibrationIlluminant3: zod_1.z.number(),
    CameraCalibration3: zod_1.z.number(),
    ColorMatrix3: zod_1.z.number(),
    ForwardMatrix3: zod_1.z.number(),
    //IlluminantData1: z.buffer(),
    //IlluminantData2: z.buffer(),
    //IlluminantData3: z.buffer(),
    MaskSubArea: zod_1.z.number(),
    //ProfileHueSatMapData3: z.buffer(),
    ReductionMatrix3: zod_1.z.number(),
    //RGBTables: z.buffer(),
})
    .describe('Contains EXIF tags for Image group (IFD).');
const PhotoTags = zod_1.z.object({
    ExposureTime: zod_1.z.number()
    ...
    SensitivityType: zod_1.z.number()
    ...
    StandardOutputSensitivity: zod_1.z.number()
    ...
    RecommendedExposureIndex: zod_1.z.number()
    ...
    ISOSpeedLatitudeyyy: zod_1.z.number()
    ...
    ISOSpeedLatitudezzz: zod_1.z.number()
    ...
    OffsetTimeDigitized: zod_1.z.string(),
    ...
    SubjectArea: zod_1.z.array(zod_1.z.number())
    ...
    PixelYDimension: zod_1.z.number()
    ...
    RelatedSoundFile: zod_1.z.string()
    ...
    InteroperabilityTag: zod_1.z.number()
    ...
    SubjectLocation: zod_1.z.array(zod_1.z.number())
    ...
    FocalLengthIn35mmFilm: zod_1.z.number()
    ...
    SceneCaptureType: zod_1.z.number()
    ...
    SubjectDistanceRange: zod_1.z.number()
        .describe('This tag indicates the distance to the subject.'),
    ImageUniqueID: zod_1.z.string()
...
const IopTags = zod_1.z.object({
    ...
    RelatedImageFileFormat: zod_1.z.string()
        .describe('File format of image file.'),
    RelatedImageWidth: zod_1.z.number()
        .describe('Image width.'),
    RelatedImageLength: zod_1.z.number()
        .describe('Image height.'),
})
    .describe('Contains EXIF tags for Iop group (IFD).');
const GPSInfoTags = zod_1.z.object({
    GPSVersionID: zod_1.z.array(zod_1.z.number())
    ...
    GPSLatitude: zod_1.z.array(zod_1.z.number())
    ...
    GPSLongitudeRef: zod_1.z.string()
    ...
    GPSLongitude: zod_1.z.array(zod_1.z.number())
    ...
    GPSTimeStamp: zod_1.z.array(zod_1.z.number())
    ...
    GPSDestLatitudeRef: zod_1.z.string()
    ...
    GPSDestLatitude: zod_1.z.array(zod_1.z.number())
    ...
    GPSDestLongitudeRef: zod_1.z.string()
        .describe('Indicates whether the latitude of the destination point is north or south latitude. The ASCII value "N" indicates north latitude, and "S" is south latitude.'),
    GPSDestLongitude: zod_1.z.array(zod_1.z.number())
    ...
    GPSDestBearingRef: zod_1.z.string()
    ...
    GPSDestDistance: zod_1.z.number()
...
//# sourceMappingURL=exif-metadata.schema.js.map